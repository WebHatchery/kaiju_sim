...
pub fn draw_kaiju_detail(
    ...
    if !drawn {
        ...
        draw_text_centered(
            "?",
            img_x + image_size / 2.0,
            img_y + image_size / 2.0,
            FONT_HERO,
            GRAY,
        );
    }
    ...
    draw_text(
        &format!("Generation: {}", kaiju.generation),
        img_x,
        info_y,
        FONT_MEDIUM,
        dark::TEXT_SECONDARY,
    ...
    draw_text(
        &format!("Genome: {}", &kaiju.genome_hash[0..8]),
        img_x,
        info_y + 35.0,
        FONT_SMALL,
        dark::TEXT_MUTED,
