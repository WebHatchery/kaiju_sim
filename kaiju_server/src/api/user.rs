...
async fn handle_login(
    ...
    let (name, image, seed, hp, atk, def, spd, element) = match choice {
        "Fire" => ("Ignis", "kaiju_fire_elemental_1768091138860.png", 101, 120, 25, 10, 12, "Fire"),
        "Ice" => ("Glacies", "kaiju_ice_elemental_1768091156648.png", 102, 110, 18, 20, 10, "Ice"),
        "Electric" | _ => ("Volt", "kaiju_electric_elemental_1768091175509.png", 103, 100, 20, 15, 15, "Electric"),
    };
